		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#proyectofinalproyectofinal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"proyectofinalproyectofinal-display": {
								"semanticObject": "proyectofinalproyectofinal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=proyectofinal.proyectofinal",
									"url": sap.ui.require.toUrl("proyectofinal/proyectofinal")
								}
							}
						}
					}
