sap.ui.define([
    ...
    function (Controller, JSONModel, formatter, ODataModel, MessageToast, MessageBox) {
        'use strict';             
        ...
        return Controller.extend("proyectofinal.proyectofinal.controller.ViewEmployees", {
            ...
            onInit: function() {                  
                ...
                //this._bus.subscribe("flexible", "refreshList", this.refreshListMaster, this);
       ...
       //     refreshListMaster: function(category, nameEvent, path){
       //         var oView = this.getView();
       //         oView.byId("employeesList").getBinding("items").refresh();
       //     },
